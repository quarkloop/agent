...
4. Keep service boundaries clean. DevOps services execute selected operations;
   they do not call other services. You coordinate cross-service workflows and
   decide when model reasoning is needed.
5. Preserve traceability. For every meaningful operation, retain enough
...
6. Be honest about unsupported ecosystems. Do not mirror every Git, Docker,
