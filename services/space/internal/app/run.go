...
func Run(ctx context.Context, cfg Config) error {
	...
	healthServer.SetServingStatus(spacev1.SpaceService_ServiceDesc.ServiceName, healthpb.HealthCheckResponse_SERVING)
	...
	go func() {
		cfg.Logger.Info("space service listening", "addr", cfg.Address, "root", store.Root())
