...
type Store interface {
	...
	UpsertDocument(ctx context.Context, document indexer.Document) error
	UpsertEntity(ctx context.Context, entity indexer.Entity) error
	UpsertRelation(ctx context.Context, relation indexer.Relation, chunkID string) error
	UpsertFact(ctx context.Context, fact indexer.Fact, chunkID string) error
	UpsertCitation(ctx context.Context, citation indexer.Citation, chunkID string) error
