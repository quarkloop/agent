...
func Descriptor(skill *servicev1.SkillDescriptor) *servicev1.ServiceDescriptor {
	return &servicev1.ServiceDescriptor{
		...
		Rpcs: []*servicev1.RpcDescriptor{
			...
			rpc("test_RunTests", "quark.devops.v1.TestService", "RunTests", "quark.devops.v1.RunTestsRequest", "quark.devops.v1.RunTestsResponse", "Run target IDs discovered by test_DiscoverTests and return bounded failure evidence, or run the default when targets are omitted."),
			rpc("test_ExplainFailure", "quark.devops.v1.TestService", "ExplainFailure", "quark.devops.v1.ExplainFailureRequest", "quark.devops.v1.ExplainFailureResponse", "Summarize bounded structured test failure evidence."),
