...
type Server struct {
	cfg    Config
	models *modelsvc.Server
	conn   *natsgo.Conn
	subs   []*natsgo.Subscription
}

func New(cfg Config, models *modelsvc.Server) *Server {
	return &Server{cfg: normalizeConfig(cfg), models: models}
}

func (s *Server) Start(ctx context.Context) error {
	if s == nil || s.models == nil {
		return fmt.Errorf("gateway model server is required")
	}
...
func (s *Server) handle(msg *natsgo.Msg) {
	...
	case functionGenerate:
		s.handleUnary(ctx, msg, req, &modelv1.GenerateRequest{}, func(ctx context.Context, request proto.Message) (proto.Message, *modelv1.ModelUsage, error) {
			resp, err := s.models.Generate(ctx, request.(*modelv1.GenerateRequest))
			return resp, resp.GetUsage(), err
		})
	case functionEmbed:
		s.handleUnary(ctx, msg, req, &modelv1.EmbedRequest{}, func(ctx context.Context, request proto.Message) (proto.Message, *modelv1.ModelUsage, error) {
			resp, err := s.models.Embed(ctx, request.(*modelv1.EmbedRequest))
			return resp, resp.GetUsage(), err
		})
	case functionRerank:
		s.handleUnary(ctx, msg, req, &modelv1.RerankRequest{}, func(ctx context.Context, request proto.Message) (proto.Message, *modelv1.ModelUsage, error) {
			resp, err := s.models.Rerank(ctx, request.(*modelv1.RerankRequest))
			return resp, resp.GetUsage(), err
		})
	case functionCountTokens:
		s.handleUnary(ctx, msg, req, &modelv1.CountTokensRequest{}, func(ctx context.Context, request proto.Message) (proto.Message, *modelv1.ModelUsage, error) {
			resp, err := s.models.CountTokens(ctx, request.(*modelv1.CountTokensRequest))
			return resp, resp.GetUsage(), err
		})
	case functionListModels:
		s.handleUnary(ctx, msg, req, &modelv1.ListModelsRequest{}, func(ctx context.Context, request proto.Message) (proto.Message, *modelv1.ModelUsage, error) {
			resp, err := s.models.ListModels(ctx, request.(*modelv1.ListModelsRequest))
			return resp, nil, err
		})
	case functionProviderHealth:
		s.handleUnary(ctx, msg, req, &modelv1.ProviderHealthRequest{}, func(ctx context.Context, request proto.Message) (proto.Message, *modelv1.ModelUsage, error) {
			resp, err := s.models.ProviderHealth(ctx, request.(*modelv1.ProviderHealthRequest))
			return resp, nil, err
		})
	case functionStreamGenerate:
		s.handleStreamGenerate(ctx, msg, req)
	case functionUsageSummary:
		s.handleUnary(ctx, msg, req, &modelv1.UsageSummaryRequest{}, func(ctx context.Context, request proto.Message) (proto.Message, *modelv1.ModelUsage, error) {
			resp, err := s.models.UsageSummary(ctx, request.(*modelv1.UsageSummaryRequest))
			return resp, nil, err
		})
	case functionReloadConfig:
		s.handleUnary(ctx, msg, req, &modelv1.ReloadConfigRequest{}, func(ctx context.Context, request proto.Message) (proto.Message, *modelv1.ModelUsage, error) {
			resp, err := s.models.ReloadConfig(ctx, request.(*modelv1.ReloadConfigRequest))
			return resp, nil, err
		})
	default:
...
type unaryHandler func(context.Context, proto.Message) (proto.Message, *modelv1.ModelUsage, error)
